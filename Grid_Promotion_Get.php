...
//Total //แก้ตรงนี้ 
$sqlcount = mysqli_query($conn,"select count(*) from promotion") or die ("Error Query [".$strSQL."]");
...
//Array //แก้ตรงนี้ 
$sqlArray = mysqli_query($conn,"select * from promotion order by id asc");
$dataArray = array();
...
//แก้ตรงนี้ 
$sqlstring 	= "select * from promotion ";

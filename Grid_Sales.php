...
<head>
	...
	<script type="text/javascript">
		...
		$(function(){
			...
			$("#dg").edatagrid({
				url: 'Grid_Sales_Get.php',
				saveUrl: 'Grid_Sales_Save.php',
				updateUrl: 'Grid_Sales_Update.php',
				destroyUrl: 'Grid_Sales_Delete.php'
...
<table id="dg" title="TEST" style="width:620px;height:250px" class="easyui-datagrid"
		...
		<thead>
			<tr>
                ...
                <th field="Promotion_id" data-options="
                    editor:{
                        type:'combobox',
                        options:{
                            valueField:'Promotion_id',
                            textField:'Promotion_id',
                            method:'get',
                            required:true								
                        }
                    }" 
                    width="20">รหัสโปรโมชั่น</th>
                ...
                width="30">ตำเเหน่งที่ตั้งสินค้า</th>
                ...
                width="30">ช่องทางการชำระเงิน</th>
	...
	<div id="toolbar" style="padding:3px">
        ...
        <tr>
            <td align="left">
                ...
                <span>Promotion_id :</span>
                <input id="Promotion_id" 	style="line-height:26px;border:1px solid #ccc"> 
                <span>Code :</span>
                ...
                <input id="Discount_amount" 	style="line-height:26px;border:1px solid #ccc">

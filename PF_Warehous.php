               ...
               <center><img class="rounded-circle" src="img/logo.jpg" style="width: 80px; height: 80;"></center><br>
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    ...
                    <div class="ms-3">
                        ...
                        <center><span>พนักงานคลังสินค้า</span></center>
                ...
                <a href="" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="button.html" class="dropdown-item">กระเป๋าสตางค์</a>
                            <a href="typography.html" class="dropdown-item">กระเป๋าถือ</a>
                            <a href="element.html" class="dropdown-item">กระเป๋าสะพาย</a>
                        </div>
					

                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2"></i>รายงาน</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="button.html" class="dropdown-item">สินค้าขายดี</a>

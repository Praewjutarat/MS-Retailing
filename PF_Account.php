...
<body>
               ...
               <center><img class="rounded-circle" src="img/logo.jpg" style="width: 80px; height: 80;"></center><br>
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    ...
                    <div class="ms-3">
                        ...
                        <center><span>พนักงานบัญชี</span></center>
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light text-center rounded p-4">
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                <h6 class="mb-0">มูลค่าสินค้าคงเหลือในคลัง</h6>
                                <a href="">Show All</a>
                            </div>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">อันดับสินค้าขายดี 5 อันดับ</h6>
                        <a href="">Show All</a>
                    </div>
